...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { article: @good.article, availability: @good.availability, content: @good.content, name: @good.name, razdel_id: @good.razdel_id, rubles: @good.rubles } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { article: @good.article, availability: @good.availability, content: @good.content, name: @good.name, razdel_id: @good.razdel_id, rubles: @good.rubles } }
